...
import { mentalHealthTopics } from "@/data/topics"
    ...
    <main className="min-h-screen bg-[#FFF5F3] overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-5 py-16">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1A1A1A]">Mental Health Topics</h2>
          <Link href="/topics" className="text-fuchsia-500 font-medium flex items-center gap-1 hover:underline">
            View All <ArrowRight size={16} />
          </Link>
        </div>

        <TopicsGrid topics={mentalHealthTopics} variant="compact" columns={4} limit={8} />
      </section>
    </main>
  )
}
